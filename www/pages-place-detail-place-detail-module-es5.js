...
var PlaceDetailPage = /** @class */ (function () {
    function PlaceDetailPage(activatedRoute, placeService, toastCtr, router) {
    ...
    PlaceDetailPage.prototype.ngOnInit = function () {
        ...
        if (id) {
            this.placeService.getPlace(id).subscribe(function (p) {
                _this.place = p;
            });
        }
    };
    PlaceDetailPage.prototype.addPlace = function () {
        var _this = this;
        this.placeService.addPlace(this.place).then(function () {
            _this.router.navigateByUrl('/places');
            _this.showToast('Place added');
        }, function (err) {
            _this.showToast('There was a problem');
        });
    };
    PlaceDetailPage.prototype.deletePlace = function () {
        var _this = this;
        this.placeService.deletePlace(this.place.id).then(function () {
            _this.router.navigateByUrl('/places');
            _this.showToast('Place deleted');
        }, function (err) {
            _this.showToast('There was a problem');
        });
    };
    PlaceDetailPage.prototype.updatePlace = function () {
        var _this = this;
        this.placeService.updatePlace(this.place).then(function () {
            _this.router.navigateByUrl('/places');
            _this.showToast('Place updated');
        }, function (err) {
            _this.showToast('There was a problem');
        });
    };
    PlaceDetailPage.prototype.showToast = function (msg) {
